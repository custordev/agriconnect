...
export default function ProductsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className=" bg-gradient-to-br from-[#004D40]  to-[#2a2817]-950 rounded-lg text-white py-16 mb-8 ">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <Button
            className="md:hidden fixed bottom-4 right-4 z-10 bg-[#004D40] text-white"
